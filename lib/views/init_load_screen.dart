...
class InitLoadState extends State<InitLoadScreen> {
  ...
  AsLineProgress progress = AsLineProgress.setUp(
      0, ColorUtils.black, ColorUtils.black, ColorUtils.secondaryColor);
  AsInformer informer = AsInformer.setUp(1, AppStrings.gettingReady,
      ColorUtils.primaryColor, Colors.transparent, ColorUtils.white, 10);
  ...
  void requestIdiomsData() async {
    ...
    dbAssets.then((database) {
      Future<List<ItemCallback>> idiomsListAsset =
          assetDB.getItemList(DbUtils.idiomsTable);
  ...
  void requestSayingsData() async {
    ...
    dbAssets.then((database) {
      Future<List<ItemCallback>> sayingsListAsset =
          assetDB.getItemList(DbUtils.sayingsTable);
  ...
  void requestProverbsData() async {
    ...
    dbAssets.then((database) {
      Future<List<ItemCallback>> proverbsListAsset =
          assetDB.getItemList(DbUtils.proverbsTable);
  ...
  Future<void> _goToNextScreen() async {
    ...
    await saveItemData(
        AppStrings.proverbs, DbUtils.proverbsTable, proverbsList);
